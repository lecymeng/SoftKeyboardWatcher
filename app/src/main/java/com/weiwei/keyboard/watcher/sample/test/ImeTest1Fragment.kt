...
import com.weiwei.keyboard.watcher.sample.databinding.FragmentImeTest1Binding
 ...
 * @date 2022.08.26
 */
class ImeTest1Fragment : Fragment() {
    private lateinit var binding: FragmentImeTest1Binding

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = FragmentImeTest1Binding.inflate(inflater, container, false)
        return binding.root
    }
